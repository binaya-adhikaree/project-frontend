  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        setError(errorData.email?.[0] || errorData.error || 'Ein Fehler ist aufgetreten');
      }
    } catch (err) {
      ...
      <div className="max-w-md w-full">
              ...
              <div className="flex items-start">
                ...
                <div className="ml-3">
                  ...
                  <p className="mt-1 text-sm text-green-700">
                    Überprüfen Sie Ihr Postfach auf Anweisungen zum Zurücksetzen des Passworts. Falls Sie die E-Mail nicht sehen, überprüfen Sie Ihren Spam-Ordner.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="block w-full pl-10 pr-3 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-yellow-500 focus:border-transparent transition-all duration-200 text-gray-900 placeholder-gray-400"
        ...
        <div className="mt-6 text-center">
          <p className="text-xs text-gray-500">
            Benötigen Sie Hilfe?{' '}
            <Link to="/contact" className="text-yellow-600 hover:text-yellow-500 font-medium">
